...
{#snippet mainBody()}
    {#each DBState.db.customModels as model, index (model.id)}
        <div class="flex flex-col mt-2">
            ...
            <SelectInput className="mt-2 mb-4" size={"sm"} value={DBState.db.customModels[index].tokenizer.toString()} onchange={(e) => {
            ...
            <SelectInput className="mt-2 mb-4" size={"sm"} value={DBState.db.customModels[index].format.toString()} onchange={(e) => {
