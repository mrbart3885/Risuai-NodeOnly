export const languageChineseTraditional = {
    ...
    "googleDriveInfo": "連線到 Google Drive 以同步您的資料。",
    "groupIcon": "群組圖示",
    "groupLoreInfo": "群組 Lorebook 會套用到群組內所有對話。",
    ...
    "hypaAllocatedTokens": "分配的 Token 數",
    "hypaChunkSize": "區塊大小",
    ...
    "loadbackup": "從 Google 載入備份",
    "lorePlus": "Lorebook+",
    "maxSupaChunkSize": "SupaMemory 最大區塊大小",
    "nodeOnlyStandardChatWidth": "對話寬度",
    "orderByOrder": "依序發言",
    "otherUserRequesting": "其他使用者正在請求中。請稍後再試。",
    "pasteAuthCode": "請從彈出視窗複製授權碼並貼到此處：",
    "realmDesc": "RisuRealm 是 Risuai 的內容分享平台。您可以將角色分享給其他使用者。",
    "removeFromGroup": "確定要將 {{char}} 從群組中移除嗎？",
    "removeGroup": "移除群組",
    "removePunctuationHypa": "記憶標點移除",
    ...
    "savebackup": "備份到 Google",
    "shareCloud": "分享到 RisuRealm",
    "supaDesc": "SupaMemory 是透過向 AI 提供摘要資料運作的長期記憶系統。",
    "system": "系統",
    "systemLogs": "系統日誌",
    ...
    "togglePresetFilterCurrentOnly": "僅目前預設",
    ...
    "updateRealmDesc": "您正嘗試將角色更新至 RisuRealm。這會更新您在 RisuRealm 上的角色，且無法還原。",
